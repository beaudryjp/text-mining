...
# Extraer de Twitter los tweets referentes a **#Brexit**
...
```{r echo=TRUE,eval=TRUE,display=TRUE,warning=FALSE}
file.csv <- stringr::str_replace_all(hashtag, "[^[:alnum:]]", "")
...
tweets.df$text <- stringr::str_replace_all("amp", " ")
...
freq.dt$termino = removeWords(freq.dt$termino, stopwords("english"))
